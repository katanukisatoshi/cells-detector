...
def main(image_path, output_path, edge_threshold1, edge_threshold2, hough_threshold, min_line_length, max_line_gap, merge_threshold, gap_threshold_top, gap_threshold_bottom, gap_threshold_left, gap_threshold_right):
...
if __name__ == '__main__':
    ...
    main(args.image_path, args.output_path, args.edge_threshold1, args.edge_threshold2, args.hough_threshold, args.min_line_length, args.max_line_gap, args.merge_threshold, args.gap_threshold_top, args.gap_threshold_bottom, args.gap_threshold_left, args.gap_threshold_right)
